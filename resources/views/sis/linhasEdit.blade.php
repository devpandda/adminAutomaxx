...
@section('subhead')
    <title>Editar o Registro: {{ $linha->nome }}</title>
@endsection
...
@section('subcontent')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-6">
            <!-- BEGIN: Form Layout -->
            <form action="{{  route('linhas.update', $linha->id)  }}" method="post">
                @csrf
                @method('put')
            <div class="intro-y box p-5">
                <div>
                    ...
                    <input id="crud-form-1 nome" name="nome" type="text" class="form-control w-full border-theme-6" placeholder="Nome da Linha" value="{{  $linha->nome  }}">
                    ...
                    <input id="crud-form-1 nome" name="nome" type="text" class="form-control w-full" placeholder="Nome da Linha" value="{{  $linha->nome  }}"> 
                    @endif
