...
<h2 class="intro-y text-lg font-medium mt-10">Controle de Atributos</h2>
@if (session('message'))
...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        <a href="{{ route('atributos.create') }}"><button class="btn btn-primary shadow-md mr-2">Adicionar Atributo</button></a>
        <div class="dropdown">
        ...
        <div class="hidden md:block mx-auto text-gray-600">Mostrando {{ count($atributos) }} registros</div>
        <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
            <div class="w-56 relative text-gray-700 dark:text-gray-300">
                <form action="{{ route('atributos.search') }}" method="post">
                    @csrf
        ...
        <table class="table table-report -mt-2">
            <thead>
                <tr>
                    ...
                    <th class="whitespace-nowrap">Atributo</th>
            ...
            <tbody>
                ...
                <tr class="intro-x">
                    <td class="w-40">{{ $atributo->id }}</td>

                    <td>
                        <a href="" class="font-medium whitespace-nowrap">{{ $atributo->nome }}</a>
                        <div class="text-gray-600 text-xs whitespace-nowrap mt-0.5">{{ $atributo->descricao }}</div>
                    </td>


                    <td class="table-report__action w-56">
                        <div class="flex justify-center items-center">
                            <a class="flex items-center mr-3" href="{{ route('atributos.edit', $atributo->id) }}">
    ...
    @if (isset($filters))
    {{ $atributos->appends($filters)->links('layout.paginator'); }}
    @else
    {{ $atributos->links('layout.paginator'); }}
    @endif
</div>
