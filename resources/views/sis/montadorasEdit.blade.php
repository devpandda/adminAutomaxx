...
@section('subhead')
    <title>Editar o Registro: {{ $montadora->nome }}</title>
@endsection

@section('subcontent')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Editando o Registo (montadora/marca): {{ $montadora->nome}}</h2>
    </div>
        ...
        <div class="intro-y col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box p-5">
                <div>
                    ...
                    <input id="crud-form-1 nome" name="nome" type="text" class="form-control w-full border-theme-6" placeholder="Nome da Linha" value="{{  $montadora->nome  }}">
                    ...
                    <input id="crud-form-1 nome" name="nome" type="text" class="form-control w-full" placeholder="Nome da Linha" value="{{  $montadora->nome  }}"> 
                    @endif
