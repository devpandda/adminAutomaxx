...
@section('subhead')
    <title>Editar o Registro: {{ $modelo->nome }}</title>
@endsection

@section('subcontent')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Editando o Registo (modelo/veiculo): {{ $modelo->nome}}</h2>
    </div>
        ...
        <div class="intro-y col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box p-5">
                <div>
                    ...
                    <input id="crud-form-1" name="nome" type="text" class="form-control w-full" placeholder="Nome do veiculo" value="{{ $modelo->nome }}">
                </div>
                ...
                <div class="mt-3">
                    ...
                    <div class="sm:grid grid-cols-2 gap-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="anoIni" class="form-control" placeholder="Inicio" aria-describedby="input-group-3" value="{{ $modelo->anoIni}}">
                        </div>

                        <div class="input-group mt-2 sm:mt-0">
                            <div id="input-group-4" class="input-group-text">Fim</div>
                            <input type="text" name="anoFim" class="form-control" placeholder="Fim"
                                aria-describedby="input-group-4" value="{{$modelo->anoFim}}">
                        </div>
                ...
                <div class="mt-3">
                    ...
                    <div class="mt-2">
                        <select name="idMontadora" data-placeholder="Seleciona a Montadora" class="tom-select w-full">
                            <option value="{{$modelo->montadora->id}}">{{  $modelo->montadora->nome }}</option>
                ...
                <div class="mt-3">
                    ...
                    <div class="mt-2">
                        <select name="idLinha" data-placeholder="Seleciona a Linha" class="tom-select w-full">
                            <option value="{{$modelo->linha->id}}">{{  $modelo->linha->nome }}</option>
